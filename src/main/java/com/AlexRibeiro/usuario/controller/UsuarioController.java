package com.AlexRibeiro.usuario.controller;

import com.AlexRibeiro.usuario.business.UsuarioService;
...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    public ResponseEntity<EnderecoDTO> atualizaEnderecp(@RequestBody EnderecoDTO dto,
